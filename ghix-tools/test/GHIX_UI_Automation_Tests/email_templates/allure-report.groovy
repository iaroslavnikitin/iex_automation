                ...
                <!-- status -->
                        <table>
                                <tbody>
                                        ...
                                        <tr>
                                                <th>Server:</th>
                                                <td>${build.environment["server"]}</td>
                                        </tr>                                       
                                        <tr>
...
<h2>Allure Results</h2>
    <table>
        <tbody>
            ...
            <tr>
                <th>Test Report:</th>
                <td><a href="${allureResultsUrl}">${allureResultsUrl}</a></td>
            </tr>
            <tr>
                <th>Execution Trend:</th>
                <td><a href="${rooturl}${build.url}allure/graph">${rooturl}${build.url}allure/graph</a></td>
            </tr>
        </tbody>
    </table>
<% } %>
