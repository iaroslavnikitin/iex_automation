Feature: Three Memeber Scenario with Grouping 
    ...
    @SimpleJ @Grouping
     Scenario Outline: Consumer flow with valid data
       ...
       Then Enter Ethnicity And Race Information Of "Additional Member 2"
        ...
        Then Select Members For Custom Grouping And Add Health Plan To The Groups
        Then Click Shop For Plans On DashBoard
        #Then Click Save And Continue On Additional Information Page
        Then Click On Shop Dental Plans
        ...
        Examples:
            | fileName  | role       |
            | ssap_threeMem_Grouping.json | individual |
