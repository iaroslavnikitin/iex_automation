...
const l2_csr_username = 'mnuat760_3_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'mnuat760_3'

inputHouseholds.forEach(file => {
    describe(`${test_case}: 2 MEMBER WITH IN QEP AND OUTSIDE SEP WITH ADDRESS CHANGE for ${file}`, function () {
