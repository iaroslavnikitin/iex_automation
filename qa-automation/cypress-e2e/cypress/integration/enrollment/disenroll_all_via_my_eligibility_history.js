...
inputHouseholds.forEach( file => {
    describe(`Disenrolls from all through My Eligibility History page - ${file}`, function() {
        ...
        it(`Disenrolls from all through My Eligibility History page - ${file}`, function () {
            //will fail due to
            cy.disenrollAllMyEligibility();
            cy.h.appStatus = "at_created"
        })
        it(`Verify dashboard`, function () {
            cy.verifyDashboard(cy.h)
        })
