...
inputHouseholds.forEach( file => {
    describe(`Disenrolls from Medical through My Eligibility History page - ${file}`, function() {
        ...
        it(`Disenrolls from Medical through My Eligibility History page - ${file}`, function () {
