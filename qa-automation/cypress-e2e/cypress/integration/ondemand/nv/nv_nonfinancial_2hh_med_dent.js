...
const l2_csr_username = 'cy2@ghix.com'
const l2_csr_pass = 'Ghix123#'
const test_case = "NonFin1"

inputHouseholds.forEach(file => {
    describe(`${test_case}: Non financial enrollment into med and dent for ${file}`, function () {
        ...
        it(`${test_case}: SSAP non financial `, function () {
            cy.verifiedSignup()
        })
        it(`${test_case}: Logout`, function () {
            cy.logout()
