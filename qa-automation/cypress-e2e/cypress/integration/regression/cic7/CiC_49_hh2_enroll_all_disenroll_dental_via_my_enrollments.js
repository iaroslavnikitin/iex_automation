...
const l2_csr_username = 'cic_49_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC49'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Enroll all Disenrolls Dental through My Enrollments page - ${file}`, function() {
