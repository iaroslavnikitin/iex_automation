...
const l2_csr_username = 'cic_51_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC51'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Enroll Medical Disenrolls Medical through My Enrollments page - ${file}`, function() {
        ...
        it(`${test_case}: Disenrolls from Health through My Enrollments page - ${file}`, function () {
            ...
            cy.h.appStatus = cy.h.oep ? "at_created" : "enroll_med_disenroll_med_birth"
        })
        it(`${test_case}: Verify dashboard`, function () {
            cy.verifyDashboard(cy.h)
        })
