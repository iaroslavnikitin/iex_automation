...
const l2_csr_username = 'cic_52_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC52'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Enroll Dental Disenrolls Dental through My Enrollments page - ${file}`, function() {
        ...
        it(`${test_case}: Disenrolls from Dental through My Enrollments page - ${file}`, function () {
            ...
            // TODO: statuses upgrade
            //  to process terminated enrollments in SEP
