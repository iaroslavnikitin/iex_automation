...
const l2_csr_username = 'cic_48_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC48'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Enroll all Disenrolls Medical through My Enrollments page - ${file}`, function() {
        ...
        it(`${test_case}: Disenrolls from Health through My Enrollments page - ${file}`, function () {
            ...
            cy.h.appStatus = cy.h.oep ? "enroll_dent" : "med_full_enroll_dent"
        })
        it(`${test_case}: Verify dashboard`, function () {
            cy.verifyDashboard(cy.h)
        })
