...
const l2_csr_username = 'cic_43_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC43'

inputHouseholds.forEach( file => {
    describe.skip(`https://jira.getinsured.com/browse/HIX-119443 ${test_case}: Enroll all Disenroll Medical via Custom Grouping page for ${file}`, function() {
