...
const l2_csr_username = 'cic_17_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC17'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Financial to Non Financial plus Add member for ${file}`, function() {
        ...
        it(`${test_case}: Change Aptc/CSR to false for ${file}`, function () {
