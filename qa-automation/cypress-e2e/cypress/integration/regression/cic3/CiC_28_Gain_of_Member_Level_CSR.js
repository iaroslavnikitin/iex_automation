...
const l2_csr_username = 'cic_28_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC28'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Gain of MemberLevel CSR for ${file}`, function() {
        ...
        it(`${test_case}: Change Member Level CSR to false for ${file}`, function () {
            cy.addMember()
            cy.h.people[0].csrEligibilityIndicator = true
            if (!cy.h.oep) cy.h.appStatus = 'enroll_med_dent_aptc_update'
        })
