...
const l2_csr_username = 'cic_14_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC14'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Adding a member plus ATC update for ${file} enrolled into silver medical/dental`, function() {
