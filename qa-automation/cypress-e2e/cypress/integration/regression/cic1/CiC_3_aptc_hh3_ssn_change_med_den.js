...
const l2_csr_username = 'cic_3_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC3'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Change SSN for ${file} enrolled into medical/dental`, function() {
        ...
        it(`${test_case}: Update SSN for ${file}`, function () {
