...
const l2_csr_username = 'cic_6_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC6'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Change uQHP to false for ${file} enrolled into medical`, function() {
