...
const l2_csr_username = 'cic_8_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC8'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Update CSR level from CS4 to CS6 for ${file}`, function() {
        ...
        it(`${test_case}: Update csrLevel from CS4 to CS6 for ${file}`, function () {
            cy.csrChange("CS6")
