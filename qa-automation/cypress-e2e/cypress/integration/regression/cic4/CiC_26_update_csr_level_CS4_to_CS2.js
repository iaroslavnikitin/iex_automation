...
const l2_csr_username = 'cic_26_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC26'

inputHouseholds.forEach( file => {
    describe(`${test_case}: AI/AN change (CS4 to CS2) for ${file} enrolled into Health/Dental`, function() {
