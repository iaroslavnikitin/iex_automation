...
const l2_csr_username = 'cic_27_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC27'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Loss of MemberLevel CSR for ${file}`, function() {
        ...
        it(`${test_case}: Change MemberLevelCSR to false for ${file}`, function () {
            cy.h.people[0].csrEligibilityIndicator = false
