...
const l2_csr_username = 'cic_18_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC18'

inputHouseholds.forEach(file => {
    describe(`${test_case}: DOB change plus Add Member for ${file} enrolled into medical/dental`, function () {
        ...
        it(`${test_case}: Verify dashboard`, function () {
            if (!cy.h.oep) cy.h.appStatus = 'med_full_enroll_dent_aian'
            cy.verifyDashboard(cy.h)
        })
