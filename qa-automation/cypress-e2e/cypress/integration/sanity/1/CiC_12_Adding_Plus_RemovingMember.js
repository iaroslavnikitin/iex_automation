...
const l2_csr_username = 'cic_12_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC12'

inputHouseholds.forEach( file => {
    describe(`${test_case}: CIC12: Adding a member and removing a member enrolled into silver medical/dental for ${file}`, function() {
        ...
        it(`${test_case}: Removing members for ${file}`, function () {
            cy.removeMember()
        })
