...
const l2_csr_username = 'cic_44_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC44'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Enroll Dental then Disenroll Dental via Custom Grouping page for ${file}`, function() {
