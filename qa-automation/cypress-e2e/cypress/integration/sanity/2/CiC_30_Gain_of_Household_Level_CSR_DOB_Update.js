...
const l2_csr_username = 'cic_30_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC30'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Gain of HouseholdLevel CSR and DOB Change for ${file}`, function() {
        ...
        it(`${test_case}: Change CSR level eligibility to false for ${file}`, function () {
