...
const l2_csr_username = 'cic_13_cypress_l2_csr@yopmail.com'
const l2_csr_pass = 'Ghix123#'
const test_case = 'CIC13'

inputHouseholds.forEach( file => {
    describe(`${test_case}: Adding a member and removing a member enrolled into silver medical/dental for ${file}`, function() {
